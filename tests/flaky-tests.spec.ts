...
describe('Flaky Tests', () => {
  it('should generate report with previous attempts correctly', async () => {
    // Arrange
    ...
    expect(test.previousAttempts).toHaveLength(2)

    const failedAttempt = test.previousAttempts![0]
    ...
    const failedAttempt2 = test.previousAttempts![1]
